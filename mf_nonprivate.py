...
#evaluate function for nonprivate method
def evaluate(model, test_ratings,user_dict,item_dict):
    ...
    for i in range(len(test_ratings)):
        ...
        #only consider users and items appear in training dataset in evaluation
...
def main():
    ...
    parser.add_argument('--data',type=str,default='Data/ml-100k',help='Path to the dataset') 
    parser.add_argument('--epochs',type=int,default=100,help='Number of total training epochs')
    parser.add_argument('--filename',type=str,default="nonprivate.csv",help='filename to store the training and testing result')
    parser.add_argument('--logfile',type=str,default="nonprivate.log",help='path to store the log file')
    ...
    try:
        ...
        for epoch in range(total_epochs):
            ...
            #evalutation on validation_set waste much time, we only need last performance
