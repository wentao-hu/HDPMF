...
#evaluate function for sampling mechanism
...
def main():
    ...
    parser.add_argument('--strategy',type=str,default="mean",help='threshold strategy for sampling mechanism')
    ...
    parser.add_argument('--filename',type=str,default="sampling.csv",help='filename to store the training and testing result')
    parser.add_argument('--logfile',type=str,default="sampling.log",help='path to store the log file')
    # hyperparameter
    ...
    try:
        ...
        model = MFModel(num_users+1, num_items+1, args.embedding_dim, args.regularization, args.stddev)
        ...
        for epoch in range(total_epochs):
            ...
            #for large dataset, output test_error only 3 times, speedup nearly 20 times
            if epoch==99:
